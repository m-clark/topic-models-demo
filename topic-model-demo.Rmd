...
# following unless it's input is a factor (col_factor), which is not even noted as an
# allowable input.
...
d3heatmap::d3heatmap(LDA_1Post$topics, Rowv = NA, Colv = NA, labRow=rep(NA, nrow(LDA_1Post$topics)),
                     colors=colorRamp(viridis::inferno(n=100), interpolate='spline', space='Lab', bias=), digits=5,
                     width=500)
...
```{r tt_ldapost, echo=1, fig.align='center'}
